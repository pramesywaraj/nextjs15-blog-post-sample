...
interface PostEditorProps {
  initialData?: any
  onSave: (data: PostEditorInput) => Promise<void>
  onCancel: () => void
  isLoading?: boolean
}
...
export default function PostEditor({ initialData, onSave, onCancel, isLoading }: PostEditorProps) {
  ...
  useEffect(() => {
    ...
    if (initialData) {
      ...
      setSelectedCategories(initialData.categories?.map((c: Category) => c.id) || [])
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            {initialData ? "Update your blog post" : "Write and publish a new blog post"}
          </p>
        </div>
