      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-slate-600 mb-8 max-w-2xl mx-auto">
            Discover insights, stories, and ideas that matter. Stay updated with our latest articles
            covering technology, design, and innovation.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-slate-400">
                A platform for sharing insights, stories, and ideas that inspire and inform.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-slate-400">
                ...
                <li><Link href="/blog" className="hover:text-white transition-colors">Categories</Link></li>
