...
async function searchPosts(query: string, category?: string) {
  try {
    ...
    const response = await fetch(`${baseUrl}/api/blog/search?${params.toString()}`, {
      cache: 'no-store'
    })
...
function SearchForm({ initialQuery, initialCategory }: { initialQuery?: string, initialCategory?: string }) {
  return (
            ...
            {query ? (
                  ...
                  <div className="text-center py-12">
                    <div className="max-w-md mx-auto">
                      ...
                      <p className="text-slate-600 mb-6">
                        No articles match your search for "{query}". Try different keywords or browse by category.
                      </p>
                      <Link href="/blog">
                        <Button>
                          <ArrowLeft className="w-4 h-4 mr-2" />
              ...
              <div className="text-center py-12">
                <div className="max-w-md mx-auto">
                  ...
                  <p className="text-slate-600 mb-6">
                    Use the search form to find articles by title, content, categories, or tags.
                  </p>
                  <Link href="/blog">
                    <Button>
                      <ArrowLeft className="w-4 h-4 mr-2" />
