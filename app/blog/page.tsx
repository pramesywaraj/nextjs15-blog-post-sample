					...
					<main className="lg:col-span-3">
						<div className="mb-6">
							...
							<p className="text-slate-600">
								Discover our latest insights, tutorials, and stories. Use the
								search form to find specific content.
							</p>
						</div>
							...
							<div className="text-center py-12">
								<div className="max-w-md mx-auto">
									...
									<p className="text-slate-600 mb-6">
										There are no published posts yet. Check back later for new
										content.
									</p>
									<Link href="/">
										<Button>
